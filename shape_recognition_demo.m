...
% 	coloredLabelsImage = label2rgb (labeledImage, 'hsv', 'k', 'shuffle'); % Unique colors.
	% Use only 4 colors.
	cMap = hsv(5);
	cMap(1,:) = [0,0,0]; % Ensure background is black.
	coloredLabelsImage = ind2rgb (labeledImage, cMap); 
